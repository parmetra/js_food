  ...
  function getDynamicInfo(selector) {
    ...
    input.addEventListener("input", function () {
      if (input.value.match(/\D/g)) {
        // подсветка инпута красным, если в поле не цифра
...
/* harmony import */ var _modals__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modals */ "./js/modules/modals.js");
...
var forms = function forms(formSelector, modalSelector, modalTimerID) {
  function showThanksModal(message) {
    var modalDialog = document.querySelector(".modal__dialog");
    modalDialog.classList.add("hide");
    (0,_modals__WEBPACK_IMPORTED_MODULE_9__.modalWindow)("show", "hide", "hidden", modalSelector, modalTimerID);
    ...
    setTimeout(function () {
      ...
      (0,_modals__WEBPACK_IMPORTED_MODULE_9__.modalWindow)("hide", "show", "", modalSelector, modalTimerID);
    }, 2000);
  }
  // Формы
  ...
  forms.forEach(function (item) {
    // Навешивание функции bindPostData (ниже) на каждую форму
    bindPostData(item);
  });
...
var modals = function modals(triggerSelector, modalSelector, modalTimerID) {
  /* Модальное окно */
  ...
  modal.addEventListener("click", function (e) {
    if (e.target === modal || e.target.getAttribute("data-close") == "") {
      // Делегирование событий на динамические крестики закрытия окон
...
var sliders = function sliders(_ref) {
  ...
  var nextSlideBtn = document.querySelector(nextArrow),
  ...
  imageSlide.forEach(function (item) {
    item.style.width = widthSlide;
  });
  nextSlideBtn.addEventListener("click", function () {
    // кнопка слайдов вперёд
    counterSlides++;
    if (offset == clearNotDigits(widthSlide) * (imageSlide.length - 1) && counterSlides > totalSlide.textContent) {
      // проверка на то, что слайд и счётчик являются последними
      offset = 0;
      counterSlides = 1;
    } else {
  ...
  prevSlideBtn.addEventListener("click", function () {
    // кнопка слайдов назад
    counterSlides--;
    if (offset == 0 && counterSlides < 1) {
      // проверка на то, что слайд и счётчик являются последними
  ...
  function isLessThanTen(number) {
    //функция добавляет `0` перед числом, если оно меньше 10
    if (number < 10) {
  ...
  function clearNotDigits(str) {
    // очистка строки от всех символов, кроме чисел
...
var timers = function timers(id, deadline) {
  // Таймер - 2 урок
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("\u041C\u044B \u043D\u0435 \u043C\u043E\u0436\u0435\u043C \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C ".concat(url, ". \u0421\u0442\u0430\u0442\u0443\u0441: ").concat(result.status));
        case 5:
          _context2.next = 7;
          return result.json();
        case 7:
...
/* harmony import */ var _modules_timers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/timers */ "./js/modules/timers.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var modalTimerID = setTimeout(function () {
    (0,_modules_modals__WEBPACK_IMPORTED_MODULE_2__.modalWindow)("show", "hide", "hidden", ".modal", modalTimerID);
  }, 300000);
  ...
  (0,_modules_timers__WEBPACK_IMPORTED_MODULE_3__["default"])(".timer", "2023-06-30");
